...
data_dir = 'D:\Mini_project1\Plant-Disease-Diagnosis-Flask-master\PlantVillage'
...
tra()in = pd.DataFrame(train_data, columns=['File', 'DiseaseID','Disease Type'])
train.tail
...
img = image.load_img('D:\Mini_project1\Plant-Disease-Diagnosis-Flask-master\PlantVillage\Pepper__bell___Bacterial_spot\0a0dbf1f-1131-496f-b337-169ec6693e6f___NREC_B.Spot 9241.JPG', grayscale=False, target_size=(64, 64))
show_img=image.load_img('D:\Mini_project1\Plant-Disease-Diagnosis-Flask-master\PlantVillage\Pepper__bell___Bacterial_spot\0a0dbf1f-1131-496f-b337-169ec6693e6f___NREC_B.Spot 9241.JPG', grayscale=False, target_size=(200, 200))
